...
using System;
    ...
    public class PlanetManager : MonoBehaviour, IMoverController
    {
        ...
        public ObjectTeleporter OnPlaygroundTeleportingZone;
        public ObjectTeleporter OnPlanetTeleportingZone;

        private List<SmartObject> _characterControllersOnPlanet = new List<SmartObject>();
