...
[CreateAssetMenu(menuName = "CharacterState/ActionState/Aerial/WallJump")]
public class WallJumpState : SmartState 
{
  ...
  public override void OnEnter(SmartObject smartObject)
	{
        ...
        //smartObject.Controller.Button4Buffer = 0;
        smartObject.Motor.BaseVelocity.y = 0;
        smartObject.CurrentAirTime = 0;
        cachedVelocity = NVMath.Planarized(smartObject.Velocity);
    }
	...
	public override void UpdateVelocity(SmartObject smartObject, ref Vector3 currentVelocity, float deltaTime)
	{
        ...
        else if ((smartObject.CurrentFrame >= JumpFrame))
        {
    ...
    {
        smartObject.MovementVector = smartObject.CachedPlanarVelocity.normalized;
        ...
        currentVelocity = (smartObject.CachedPlanarVelocity * JumpScalableForwardSpeed);
		dir = smartObject.CachedPlanarVelocity.normalized;
        setdir=true;
