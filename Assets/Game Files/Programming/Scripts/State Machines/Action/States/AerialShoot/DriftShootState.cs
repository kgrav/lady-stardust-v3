...
[CreateAssetMenu(menuName = "CharacterState/ActionState/AerialShoot/Drift")]
public class DriftShootState : SmartState
{
    ...
    {
        if (smartObject.LocomotionStateMachine.PreviousLocomotionEnum == LocomotionStates.Aerial && smartObject.ActionStateMachine.PreviousActionEnum == ActionStates.Move)
        {
