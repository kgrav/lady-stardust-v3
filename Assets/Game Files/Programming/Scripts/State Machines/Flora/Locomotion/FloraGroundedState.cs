...
using UnityEngine;
[CreateAssetMenu(menuName = "CharacterState/Flora/LocomotionState/Default")]
public class FloraDefaultLocomotionState : FLocomotionState
{
    public float MaxStableMoveSpeed;
    public float StableMovementSharpness;
    public int FinishRotationTime;
    public float friction;
    public override void OnEnter(FloraSmartObject smartObject)
	{
	...
	public override void OnExit(FloraSmartObject smartObject)
	{

	}

    public override void UpdateRotation(FloraSmartObject smartObject, ref Quaternion currentRotation, float deltaTime)
    {
    ...
    public override void UpdateVelocity(FloraSmartObject smartObject, ref Vector3 currentVelocity, float deltaTime)
	{

    }

	public override void BeforeCharacterUpdate(FloraSmartObject smartObject, float deltaTime)
	{

	}

	public override void AfterCharacterUpdate(FloraSmartObject smartObject, float deltaTime)
	{

	}

	public override void PostGroundingUpdate(FloraSmartObject smartObject, float deltaTime)
	{
	...
	public override void CalculateStateVelocity(FloraSmartObject smartObject, ref Vector3 currentVelocity, float deltaTime)
	{
